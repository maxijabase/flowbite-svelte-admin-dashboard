        ...
        <div slot="slide" let:index>
            {#if index == 0}
                <div in:fly={transitionSlideIn} out:fly={transitionSlideOut} class="h-full">
                    ...
                    <p class="mb-4 text-gray-500 dark:text-gray-400">
                        Get started with a free and open-source admin dashboard layout built with
                        Tailwind CSS and Flowbite featuring charts, widgets, CRUD layouts,
                    ...
                    <ul class="mb-4 list-disc space-y-3 pl-4 text-gray-500 dark:text-gray-400">
                        ...
                        <li>
                            How the online delivery business model is diversifying to meet new
                            demands.
                        </li>
                        <li>
                            Which new technology requirements must be met to ensure true retail
                            experiences.
                        </li>
                    </ul>
                </div>
            {:else if index == 1}
                <div in:fly={transitionSlideIn} out:fly={transitionSlideOut} class="h-full">
                    ...
                    <p class="mb-4 text-gray-500 dark:text-gray-400">
                        Marketing, sales &amp; business growth for small business. Improve your
                        marketing &amp; promotion results - and grow your sales!
                    </p>
                    ...
                    <ul
                        role="list"
                        class="mb-4 list-disc space-y-3 pl-2 text-gray-500 dark:text-gray-400"
                    >
